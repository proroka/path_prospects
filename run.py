...
def get_setup_fns(priority_scheme, tiebreak_scheme, static=False):
  ...
  def surroundings_10_priority(robot, environment, limit=None):
    return robot.obstacles(environment, limit=10)
  def naive_surroundings_10_priority(robot, environment, limit=None):
    return robot.naive_obstacles(environment, limit=10)
  ...
  def surroundings_30_priority(robot, environment, limit=None):
    return robot.obstacles(environment, limit=30)
  def naive_surroundings_30_priority(robot, environment, limit=None):
    return robot.naive_obstacles(environment, limit=30)
